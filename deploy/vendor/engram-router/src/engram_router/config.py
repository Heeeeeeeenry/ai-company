...
class EntityConfig:
    ...
    # ── Chinese surnames (百家姓 top 100 + common compound surnames)
    surname_chars: str = (
        "张李王赵刘陈杨黄周吴徐孙马朱胡林郭何高罗"
    ...
    compound_surnames: list[str] = field(default_factory=lambda: [
        "欧阳", "上官", "司马", "诸葛", "独孤", "慕容", "宇文",
        "东方", "皇甫", "令狐", "端木", "公孙", "夏侯", "轩辕",
    ])
    name_breakers: str = (
    ...
    time_patterns: list[str] = field(default_factory=lambda: [
        ...
        r"最近", r"刚才", r"现在", r"前一会儿", r"前几天",
        r"前[两三四五]个?[周月]",
        r"去年", r"今年", r"明年",
        r"上半年", r"下半年", r"上季度", r"下季度",
...
class RecallWeightsConfig:
    ...
    """RRF weight for the HyDE-derived result list (0.25 = 25% of primary channels)."""
